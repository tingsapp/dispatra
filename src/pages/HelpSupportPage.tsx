        ...
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-slate-700 hover:text-slate-900 bg-slate-100 hover:bg-slate-200/80 rounded-lg transition-colors border border-slate-200"
            >
        ...
        <div className="space-y-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 text-xs text-slate-900 bg-white border border-slate-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-slate-900/10 focus:border-slate-400 shadow-xs"
            />
            {searchQuery && (
              <button
                type="button"
                onClick={() => setSearchQuery('')}
                className="absolute right-3 top-2.5 text-xs text-slate-400 hover:text-slate-600 px-1.5 py-0.5"
              >
                Clear
              </button>
            )}
          ...
          <form onSubmit={handleSubmitTicket} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                >
                  <option value="optimization">Route Optimizer / Proposal Anomaly</option>
                  <option value="telemetry">Driver App GPS / Telemetry Connectivity</option>
                  <option value="pricing">Services, Accessorials & Simulator</option>
                  <option value="tracking">Customer Tracking Link</option>
                  <option value="account">Account & Dispatch Permissions</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 text-xs text-slate-900 bg-white border border-slate-200 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-slate-900/10 focus:border-slate-400"
                >
                  <option value="normal">Normal (Inquiry / Non-blocking)</option>
                  <option value="high">High (Active Delivery Delayed)</option>
                  <option value="urgent">Critical (Active Route Blocked)</option>
                </select>
              </div>
            </div>
