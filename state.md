...
| `Sidebar`, `TopMetrics`, `DateControl`, `MapControls`, `DriverPopover`, `JobDetailPopover`, `DetailModalDialog` | Monitor chrome and contextual interactions | Navigation changes local selected tab/toasts; dedicated CRUD/planning/report/settings pages are not implemented in the inspected app |
